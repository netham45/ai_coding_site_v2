...
- every phase must follow the repository standard richer plan schema
- the standard richer plan schema includes `Goal`, `Rationale`, `Related Features`, `Required Notes`, and `Scope`
...
- every phase must address database, CLI, daemon, website, YAML, prompts, tests, performance, and notes
