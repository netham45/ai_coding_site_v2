...
- freeze vocabulary for profiles, layouts, briefs, blocked mutations, and checklist execution mode
...
- freeze the core vocabulary for profiles, layouts, briefs, blocked mutations, checklist items, blockers, and `not_applicable`
...
- current code has no workflow-profile or checklist-aware compile contract to freeze against, so this setup slice must normalize notes before code can follow
