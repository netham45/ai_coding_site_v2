...
The following goal IDs are normalized from `notes/original_concept.md`.
...
This table maps the original goals to tracked feature IDs from `notes/major_feature_inventory.md`.
...
| Artifact | State |
| --- | --- |
| `notes/original_concept.md` | exists |
| `notes/yaml_schemas_spec_revised.md` | exists |
| `notes/database_schema_spec_revised.md` | exists |
| `notes/node_lifecycle_spec_revised.md` | exists |
| `notes/runtime_command_loop_spec.md` | exists |
| `notes/cli_surface_spec_revised.md` | exists |
| `notes/git_rectification_spec_revised.md` | exists |
| `notes/full_spec_expansion_plan.md` | exists |
| `notes/major_feature_inventory.md` | exists |

### Supporting planning and review artifacts

| Artifact | State | Purpose |
| --- | --- | --- |
| `notes/yaml_inventory_v2.md` | exists | Full YAML schema family and file inventory. |
| `notes/default_yaml_library_plan.md` | exists | Concrete default YAML file set and relationships. |
| `notes/database_schema_v2_expansion.md` | exists | Migration-grade DB detail and constraints. |
| `notes/runtime_pseudocode_plan.md` | exists | End-to-end pseudocode modules and flow ownership. |
| `notes/cross_spec_gap_matrix.md` | exists | Consolidated gap and contradiction review. |
| `notes/auditability_checklist.md` | exists | Reproducibility and no-hidden-state review checklist. |
| `notes/action_automation_matrix.md` | exists | Mapping of user-visible actions to CLI/runtime/DB changes. |
| `notes/prompt_library_plan.md` | exists | Default prompt pack for generation, runtime guidance, recovery, and failure handling. |

### Canonical v2 specs

| Artifact | State | Purpose |
| --- | --- | --- |
| `notes/yaml_schemas_spec_v2.md` | exists | Canonical v2 YAML schema spec. |
| `notes/database_schema_spec_v2.md` | exists | Canonical v2 DB spec. |
| `notes/node_lifecycle_spec_v2.md` | exists | Canonical v2 lifecycle spec. |
| `notes/runtime_command_loop_spec_v2.md` | exists | Canonical v2 runtime loop spec. |
| `notes/cli_surface_spec_v2.md` | exists | Canonical v2 CLI spec. |
| `notes/git_rectification_spec_v2.md` | exists | Canonical v2 git/rectification spec. |

### Focused appendix and closure notes

| Artifact | State | Purpose |
| --- | --- | --- |
| `notes/parent_failure_decision_spec.md` | exists | Failure-classification and parent decision logic. |
| `notes/session_recovery_appendix.md` | exists | Recovery scenarios and replacement-session model. |
| `notes/override_conflict_semantics.md` | exists | Deterministic override merge and conflict rules. |
| `notes/cutover_policy_note.md` | exists | Candidate versus authoritative lineage and cutover timing. |
| `notes/provenance_identity_strategy.md` | exists | Code-entity identity strategy over time. |
| `notes/compile_failure_persistence.md` | exists | Compile-failure stages, classes, and persistence model. |
| `notes/runtime_environment_policy_note.md` | exists | Optional isolated execution policy. |
| `notes/state_value_catalog.md` | exists | Shared bounded vocabulary for statuses and types. |
| `notes/child_materialization_and_scheduling.md` | exists | Child creation and readiness model. |
| `notes/hook_expansion_algorithm.md` | exists | Hook selection, ordering, and expansion algorithm. |
| `notes/invalid_dependency_graph_handling.md` | exists | Structural and runtime dependency validation rules. |
| `notes/manual_vs_auto_tree_interaction.md` | exists | Manual/layout authority and hybrid-tree behavior. |
| `notes/child_session_mergeback_contract.md` | exists | Parent/child-session return payload contract. |
| `notes/pause_workflow_event_persistence.md` | exists | Narrow workflow-event persistence model. |
| `notes/implementation_slicing_plan.md` | exists | Dependency-ordered implementation slices. |
...
1. update feature statuses in `notes/major_feature_inventory.md`
2. update coverage values in this matrix
3. add any newly discovered artifacts to the artifact inventory
4. record new gaps in `notes/cross_spec_gap_matrix.md`
...
1. add or update the feature in `notes/major_feature_inventory.md`
