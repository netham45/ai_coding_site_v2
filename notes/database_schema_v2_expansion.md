...
This is not yet the final canonical v2 schema spec. It is the expansion and hardening plan that should feed into `notes/database_schema_spec_v2.md`.
...
1. write `notes/runtime_pseudocode_plan.md`
2. use that pseudocode to confirm missing DB state
3. draft `notes/database_schema_spec_v2.md`
4. optionally write a dedicated `notes/state_value_catalog.md` for bounded statuses/types
