...
7. Parallel-safe execution is a repository testing contract rather than optional hardening; if a test surface fails only under concurrent execution, that exposes a defect in isolation, fixture ownership, or runtime coordination rather than an acceptable serial-only proving posture.
