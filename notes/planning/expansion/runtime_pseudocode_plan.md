...
This is not the final runtime spec. It is the planning document for the pseudocode package that should feed into `notes/specs/runtime/runtime_command_loop_spec_v2.md` and related v2 specs.
