...
The broader prompt pack lives in `notes/prompt_library_plan.md`, but these templates belong here because they define family-level expectations.
...
4. rerun `notes/cross_spec_gap_matrix.md` and lower the status of the gaps this resolves
